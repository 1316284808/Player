    ...
    public class LoadConfigManager
    {
        ...
        public static AppSettings LoadSettings()
        {
            try
            {
                ...
                string json = File.ReadAllText(SettingPath.SettingsPath);
        ...
        public static ThemeSettings LoadTheme()
        {
            try
            {
                ...
                string json = File.ReadAllText(SettingPath.ThemePath);
        ...
        {
            SaveConfig(SettingPath.SettingsPath, settings);
        }
        ...
        {
            SaveConfig(SettingPath.ThemePath, theme);
        }
        ...
        public static HardwareSettings LoadHardwareSettings()
        {
            try
            {
                ...
                string json = File.ReadAllText(SettingPath.HardwarePath);
        ...
        {
            SaveConfig(SettingPath.HardwarePath, settings);
        }
        ...
        private static HardwareSettings CreateDefaultHardwareSettingsFile()
        {
            ...
            SaveConfig(SettingPath.HardwarePath, defaultSettings);
        ...
        private static AppSettings CreateDefaultSettingsFile()
        {
            ...
            SaveConfig(SettingPath.SettingsPath, defaultSettings);
            return defaultSettings;
        }
        ...
        private static ThemeSettings CreateDefaultThemeFile()
        {
            ...
            SaveConfig(SettingPath.ThemePath, themeSettings);
